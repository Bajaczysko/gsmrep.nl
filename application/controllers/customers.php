...
class customers extends CI_Controller {
    ...
    public function newcustomer()
    {
        ...
        // load interface
        $this->interface_model->full_interface('customers/new_customer_view', $this->data, $this->language_model->translate('New customer'));
    ...
    public function customeroverview()
    {
        ...
        if (! $this->flexi_auth->is_privileged('11'))
        {
            $this->session->set_flashdata('message', '<p class="error_msg">You do not have privileges to view customers.</p>');
            redirect('auth');
        }
        ...
        if ($this->input->post('search_customer') && $this->input->post('search_query'))
        {
            ...
            redirect('customers/customeroverview/search/'.$search_query.'/page/');
        }
        ...
        // load interface
        $this->interface_model->full_interface('customers/customeroverview_view', $this->data, $this->language_model->translate('Customer overview'));
    ...
    public function smartgroups()
    {
        ...
        // load interface
        $this->interface_model->full_interface('customers/smartgroups_view', $this->data, $this->language_model->translate('Smart groups'));
