...
<div class="container clearfix">
    ...
    <h2><?php echo $this->language_model->translate('Add a item to current bill'); ?></h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
            <input type="text" name="search_product" placeholder="Search" id="inputEmail" class="form-control">
            </div>
