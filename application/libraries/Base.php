...
class Base {
	...
	/**
	 * Method to create bootstrap style alert notification 
	 * html snippet
	 *
	 * @param  string  $msg  notification message
	 * @param  string  $type  alert type: danger, warning, info, success
	 *
	 * @return  string  alert notification bootstrap html
	 */
	public function set_message($msg,$type)
	{
		return '<div class="alert alert-'.$type.' fade in" role="alert"><button type="button" class="close" data-dismiss="alert">
		<span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>'.$msg.'</div>';
	}
	 ...
	 * @param  string  $type  type of message: success, warning, info, danger(error), uses bootstrap style
	 */
	public function set_notification($msg,$type)
	{	
		// get bootstraped html message					
		$message = $this->set_message($msg,$type);
